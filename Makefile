...
OBJS = $(PLUGIN).o mediaplayer.o softhddevice.o video.o audio.o codec_audio.o codec_video.o ringbuffer.o buf2rgb.o logger.o threads.o grab.o videostream.o h264parser.o
